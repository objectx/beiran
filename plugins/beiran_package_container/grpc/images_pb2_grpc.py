...
from . import images_pb2 as images__pb2
...
class ImagesStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Get = channel.unary_unary(
        ...
        request_serializer=images__pb2.GetImageRequest.SerializeToString,
        response_deserializer=images__pb2.GetImageResponse.FromString,
        )
...
def add_ImagesServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Get': grpc.unary_unary_rpc_method_handler(
          servicer.Get,
          request_deserializer=images__pb2.GetImageRequest.FromString,
          response_serializer=images__pb2.GetImageResponse.SerializeToString,
      ),
